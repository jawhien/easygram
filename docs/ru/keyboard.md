...
* Alt + 1 - Перейти к списку чатов.
* Alt + 2 - перейти к списку контактов.
* Alt + F - Выбор папки с чатами.
* Control + Shift + F - Открыть окно поиска
* Control + M - Открыть мой профиль
* Control + P - Открыть настройки.
* Control + F1 - Открыть журнал.
* F1 - О программе.

## Список чатов

* Control + Shift + Delete - Очистить историю чата
...
* Alt+цифры от 1 до 0 - чтение последних десяти сообщений, где цифра 1 - самое последнее сообщение, а 0 - десятое с конца. При двойном нажатии устанавливает фокус на это сообщение.
...
* Alt + F10 - Перейти к следующему непрочитанному упоминанию.
* Alt + F11 - Перейти к следующей непрочитанной реакции.
...
* Alt + Q - Прочитать цитируемое сообщение. При двойном нажатии - перейти к цитируемому сообщению.
* Alt+End - перейти к последнему сообщению
* Control + End - Перейти к последнему сообщению, тоже самое, что и Alt + End.
...
* Control + S - Сохранить файл в загрузки.
...
* Alt + E - Перейти в поле ввода.
* Alt + R - Перейти к списку результатов.
* Control + Delete - Очистить историю поисковых запросов.
